        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" novalidate action="<?php echo base_url();?>Admin/record/update" method="post">
                <input type="hidden" class="form-control" name="idRecord" id="idRecord" value="<?php echo $this->uri->segment(3) ?>">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select" aria-label="Default select example" name="inputSex" id="inputSex" readonly>
                    <?php
                        ...
                        $sex = $resdata[0]->sex;
                        ($sex == 1) ? $isSelectedF : $isSelectedF = "";
                        ($sex == 2) ? $isSelectedM : $isSelectedM = "";

                        $opt = "<option value='1' ".$isSelectedF.">Female</option>".
                                "<option value='2' ".$isSelectedM.">Male</option>";
